...
abstract class ImageUtils {
  companion object {
    ...
    /**
     * Convert a bitmap to a TensorImage for the detection model with target size
     *
     * @param bitmapIn
     * - the bitmap to convert
     * @param width
    ...
    /**
     * Convert a bitmap to a TensorImage for the display detection model with target size and normalization
     *
     * @param bitmapIn
     * - the bitmap to convert
     * @param width
     ...
     * - stds of the images
     */
    fun bitmapToTensorImageForDisplayDetection(
      bitmapIn: Bitmap,
      width: Int,
      height: Int,
      mean: Float,
